...
*[Good, How about you?]I'm doing alright myself. How are you sir?
    Oh, I'm not doing so well. I've been wandering the forest as I normally do and have seem to hurt my back. Not to be a bother though. I must get going or dinner is going to get cold.
...
== SELLING
*[Buy this leaf.] I have a rare herb with me from my travels. It grows only on the highest of mountains far in the north.
...
**[I meant south]Did I say north? I meant south. The peaks of mountains in the south.
    ...
    ***[Run]LOOK! A WORKING OPTIONS MENU!
        Where?
        ->END
    ***[Buy something else]Let me see what else I have.
        It best be good
        ->SELLING
...
**[Nother than north]Yes, if you travel very far.
    ...
    ***[Brew the leaf]When brewed into a hot tea this herb can cure any of your stiff joints and you will wake up feeling as limber as that one really limber person.
        ...
        Errrrr...
        ****[Run]Let me go find that guy real quick.
            If My joints worked then I would follow you but I guess I'm stuck here. 
            ->END
        ****[Buy something else]Let me see what else I have.
        It best be good
        ->SELLING
    ***[Eat the leaf]When consumed, this leaf will stop all joint pain for a week. You should be able to get home after this.
        That sounds alright. But i only have 50 copper on me. Will that be enough?
        ****[Yes]That's a little low but it's ok. I'll take that.
        Subarashi!! My joints feel better already!
        what?
        What?
        ->END
        ****[MORE]It's going to take a bit more than that.
            I don't have anything else young man. perhaps you can offer me something else?
            ->SELLING
*[Buy this potato]Here I hold a mystical stone of life. It bears many healing properties which must be activated.
    How does it work?
    **[Plant it]Legend has it that if you place this rock in a hole in the ground it will take root and using the power of the sun, create a herb with all of it's properties. Once purple flowers start to bloom, you should be able to dig it up and find new stones. The plant itself will heal you through it's magic aura. And theese new stones will also function just like the original.
        That sounds great! But you see I only have 50 copper with me. I hope that will suffice.
        ***[Yes]That's a little low but it's ok. I'll take that.
        I guess i'll have to go and get to work now. Thank you.
        ->END
        ***[MORE]I'm afraid that's just not enough. Theese things are rare to come by. And if you're willing to put in the work you could make infinate numbers of them. I just can't let this go for so little.
            If I had anything else I would offer it. Perhaps you can see if you have anything else?
            ->SELLING
